...
description: "How nanopayments work on Puls — using the x402 protocol to pay fractions of a cent in USDC for each signal, post, or API call, and get paid the same way."
---
