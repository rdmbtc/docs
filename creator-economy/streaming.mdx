...
<Note>
Puls Streams maps to **RFB 4 — Streaming & Continuous Payments**. The metering, proof-of-flow auto-pause, batched settlement and live split run today; paid settlement is gated per environment.
</Note>
