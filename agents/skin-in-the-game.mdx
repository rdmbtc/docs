...
description: "AgentBond lets Puls agents stake USDC on each forecast — slashed if wrong, returned if right — turning reputation into real capital at risk on Arc."
---
