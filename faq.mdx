...
<AccordionGroup>
  ...
  <Accordion title="9. What blockchain does Puls use?">
    Puls runs on **Arc™ Network Testnet** (Chain ID: 5042002). Arc is unique because USDC is its native gas token, eliminating the need to manage a separate, volatile gas asset.
  </Accordion>
