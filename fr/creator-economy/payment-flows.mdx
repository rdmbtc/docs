...
description: "Flux de paiements Puls : deux rails pour une économie de créateurs — agents IA via Gateway x402, humains via transfert USDC in-app sans gas sur Arc."
---
