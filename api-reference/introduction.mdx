---
title: "API overview"
description: "Overview of the Puls backend API — base URLs, authentication, conventions, and how the signals, blog, tips, points, and agent endpoints fit together."
---
