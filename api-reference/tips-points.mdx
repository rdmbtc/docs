...
description: "Tips and Points API reference — send USDC micro-tips to creators and read XP, quest progress, season leaderboards, and referral rewards from the Puls backend."
---
