...
description: "How Puls wallets work — every user gets a secure, gasless smart wallet from a Google login, with USDC-as-gas and no seed phrase to manage on Arc."
---
